...
// Prefer compiler builtins when available (Clang/GCC)
...
#    else
#        define ROTL32(x, r) (static_cast<uint32_t>(((x) << (r)) | ((x) >> (32 - (r)))))
#        define ROTL64(x, r) (static_cast<uint64_t>(((x) << (r)) | ((x) >> (64 - (r)))))
#    endif
#endif
...
struct FNV1a {
    static void hash_x64_64(const void *data,
        ...
        void *out)
    {
        // Suppress unused-parameter warning on MSVC when warnings are treated as errors
        (void)seed;
